    ...
    <div className="bg-white text-[#0f0e2a]">
      ...
      <div className="relative overflow-hidden" style={{ minHeight: "100vh" }}>
        ...
        <div
          ...
          style={{ transform: `translateX(-${slide * 100}%)`, minHeight: "100vh" }}
        >
          {/* ── Slide 1: VentureD Hero ── */}
          <section
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
              {[
                { s: 22,  top: "12%", right: "46%", c: "#22d3ee" },
                { s: 42,  top: "28%", right: "40%", c: "#4ade80" },
                { s: 68,  top: "44%", right: "32%", c: "#86efac" },
                { s: 110, top: "52%", right: "20%", c: "#fbbf24" },
                { s: 150, top: "36%", right: "6%",  c: "#fb923c" },
                { s: 90,  top: "68%", right: "2%",  c: "#f87171" },
                { s: 36,  top: "8%",  right: "26%", c: "#a3e635" },
                { s: 18,  top: "72%", right: "38%", c: "#34d399" },
                { s: 55,  top: "18%", right: "14%", c: "#60a5fa" },
                { s: 30,  top: "60%", right: "46%", c: "#fde68a" },
                { s: 70,  top: "78%", right: "12%", c: "#c084fc" },
                { s: 25,  top: "85%", right: "30%", c: "#22d3ee" },
              ].map((c, i) => (
                <div key={i} className="absolute rounded-full"
                  style={{ width: c.s, height: c.s, top: c.top, right: c.right, background: c.c, opacity: 0.82, filter: "blur(0.8px)" }} />
              ))}
            </div>
            ...
            <a
              ...
              className="relative z-10 flex flex-col justify-center max-w-7xl mx-auto px-8 h-full"
              ...
              <div className="max-w-[620px]">
                ...
                <div className="flex items-center gap-3 mb-10">
                  ...
                  <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0"
                    ...
                    <div className="w-4.5 h-4.5 rounded-full" style={{ width: "18px", height: "18px", background: "#0a1a6e" }} />
                  </div>
                ...
                <p className="text-white font-bold text-xl mb-2" style={{ opacity: 0.85 }}>
                  Global Open-source AI Challenge
                </p>
                <p className="mb-10 text-base" style={{ color: "rgba(163,230,53,0.9)", fontWeight: 600 }}>
